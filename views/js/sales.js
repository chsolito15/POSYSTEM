      	...
      	success:function(answer){
	          ...
	          '<div class="col-xs-6" style="padding-right:0px">'+
	            ...
	            '<div class="input-group mb-2">'+
	              ...
	              '<span class="bg-danger"><button type="button"class="btn btn-default btn-xs removeProduct" idProduct="'+idProduct+'"><i class="fa fa-close"></i></button></span>'+
      	...
      	success:function(answer){
	          ...
	          '<div class="col-xs-3" style="padding-right:0px">'+
	            ...
	            '<div class="input-group mb-2">'+
	              ...
	              '<span class="bg-danger"><button type="button" class="btn btn-xs removeProduct" idProduct><i class="fa fa-close"></i></button></span>'+

	              '<select class="form-select newProductDescription" id="product'+numProduct+'" idProduct name="newProductDescription" required>'+
...
$("#newPaymentMethod").change(function(){
	...
	if(method == "cash"){
		...
		'<div class="col" id="getCashChange" style="padding-left:0px">'+
	 ...
	 '</div>'
		...
		$(this).parent().parent().addClass('col-xs-6');
		 ...
		 $(this).parent().parent().parent().children('.paymentMethodBoxes').html(
		 	...
		 	'<div class="col mt-3" style="padding-left:0px">'+
